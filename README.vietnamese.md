...
[<img src="assets/images/twitter.svg" width="16" height="16" alt="" />](https://twitter.com/nodepractices/) **Theo dõi trên Twitter!** [**@nodepractices**](https://twitter.com/nodepractices/)

<br/>

Đọc với ngôn ngữ khác: [![CN](./assets/flags/CN.png)**CN**](./README.chinese.md), [![FR](./assets/flags/FR.png)**FR**](./README.french.md), [![BR](./assets/flags/BR.png)**BR**](./README.brazilian-portuguese.md), [![RU](./assets/flags/RU.png)**RU**](./README.russian.md), [![PL](./assets/flags/PL.png)**PL**](./README.polish.md), [![JA](./assets/flags/JA.png)**JA**](./README.japanese.md), [![EU](./assets/flags/EU.png)**EU**](./README.basque.md) [(![ES](./assets/flags/ES.png)**ES**, ![HE](./assets/flags/HE.png)**HE**, ![KR](./assets/flags/KR.png)**KR** and ![TR](./assets/flags/TR.png)**TR** in progress! )](#translations)

<br/>

# Chào mừng! 3 điều đầu tiên bạn nên biết 

**1. Bạn đang đọc rất nhiều bài viết hay về Node.js -** Repository này đã tóm tắt và tuyển chọn những nội dung được xếp hạng cao trên các phương pháp, thực hành với Node.js.

**2. Đây là bộ sưu tập lớn nhất, và nó được phát triển hàng tuần -** Hiện tại, có hơn 80 mẫu thực hành, phương phát hay nhất, các tiêu chuẩn, và những thủ thuật xây dựng kiến trúc được thể hiện. Các vấn đề mới, pull requests được tạo ra hàng ngày để giữ cho bộ sưu tập này luôn được cập nhật theo thời gian. Chúng tôi mong muốn nhìn thấy những đóng góp của bạn tại đây, để sửa đổi những nội dung như code lỗi, dịch ngôn ngữ hoặc đề xuất những ý tưởng thú vị mới. Tham khảo [hướng dẫn](./.operations/writing-guidelines.md)

**3. Thông tin các phương pháp, thực hành -** Hầu hết các gạch đầu dòng đều có **🔗Xem thêm** link này sẽ đưa bạn đến nội dung chi tiết về ví dụ code, trích dẫn, và nhiều nội dung khác
...
&emsp;&emsp;[1.5 Tách biệt các môi trường ứnng dụng, cấu hình bảo mật và phân cấp `#modified-recently`](#-15-use-environment-aware-secure-and-hierarchical-config)</br>

</details>

<details>
  <summary>
    <a href="#2-error-handling-practices">2. Phương pháp xử lý lỗi (12)</a>
  </summary>

&emsp;&emsp;[2.1 Sử dụng Async-Await hoặc promises cho xử lý lỗi bất đồng bộ](#-21-use-async-await-or-promises-for-async-error-handling)</br>
&emsp;&emsp;[2.2 Chỉ sử dụng đối tượng Error built-in `#strategic`](#-22-use-only-the-built-in-error-object)</br>
&emsp;&emsp;[2.3 Phân biệt lỗi vận hành và lỗi chương trình `#strategic`](#-23-distinguish-operational-vs-programmer-errors)</br>
&emsp;&emsp;[2.4 Xử lý lỗi tập trung, không dùng với middleware `#strategic`](#-24-handle-errors-centrally-not-within-a-middleware)</br>
&emsp;&emsp;[2.5 Các lỗi API khi sử dụng Swagger hoặc GraphQL `#modified-recently`](#-25-document-api-errors-using-swagger-or-graphql)</br>
&emsp;&emsp;[2.6 Thoát khỏi tiến trình khi gặp lỗi đang tin cậy `#strategic`](#-26-exit-the-process-gracefully-when-a-stranger-comes-to-town)</br>
&emsp;&emsp;[2.7 Sử dụng logger để hiển thị lỗi](#-27-use-a-mature-logger-to-increase-error-visibility)</br>
&emsp;&emsp;[2.8 Luồng kiểm tra lỗi sử dụng các framework bạn hay dùng](#-28-test-error-flows-using-your-favorite-test-framework)</br>
&emsp;&emsp;[2.9 Sử dụng APM để monitor ứng dụng](#-29-discover-errors-and-downtime-using-apm-products)</br>
&emsp;&emsp;[2.10 Bắt những sự kiện huỷ promise không được xử lý `#modified-recently`](#-210-catch-unhandled-promise-rejections)</br>
